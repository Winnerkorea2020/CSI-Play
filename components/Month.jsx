...
import { topTenCoins } from "@/constant";
    ...
    <div>
      <div className="w-full h-full overflow-y-auto overscroll-y-auto scroll">
        <ul className="w-full h-full px-3 mt-5 flex flex-col gap-6 py-8">
          {topTenCoins.map((tenCoins, index) => (
              ...
              <Link href="#none" className="w-full">
                <div className="flex justify-start items-start">
                  ...
                  <div className="w-full ml-3">
                    <p className="text-start font-medium text-xs tracking-tighter">{tenCoins.coinTitle}</p>

                    <div className="text-xs font-medium">{`${tenCoins.coinName}/KRW`}</div>
                  </div>
                  <div className="w-fit">

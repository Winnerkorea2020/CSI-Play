...
const TableReportBody = ({ topics }) => {
  ...
  return (
    <div class="relative w-full flex-col rounded-xl bg-transparent bg-clip-border text-gray-700 grid grid-cols-1 gap-y-4 ">
      {topics.map((topics) => (
        <div
          key={topics.id}
          className="px-4 py-5 border bg-white rounded-lg shadow-sm shadow-gray-100 "
        >
          <div class="relative flex items-center gap-4  pb-8 mx-0 overflow-hidden text-gray-700 bg-transparent shadow-none rounded-xl bg-clip-border ">

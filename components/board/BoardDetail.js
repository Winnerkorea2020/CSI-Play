...
const BoardDetail = () => {
  ...
  return (
    <div>
      <div>
        <div className="pb-5">
          <h2 className="py-2 font-medium text-lg tracking-tighter truncate whitespace-normal">제목입니다.</h2>
          <div className="">
            ...
            <div className="flex justify-between items-center gap-2">
              <div className="flex justify-start items-center gap-2">
                <div className="text-xs">
                  <span className="text-xs lg:text-sm xl:text-base xl:font-medium">댓글</span>
                  <span className="text-xs lg:text-sm xl:text-base xl:font-medium">2</span>
                </div>
                <div className="text-xs">
                  <span className="text-xs lg:text-sm xl:text-base xl:font-medium">추천</span>
                  <span className="text-xs lg:text-sm xl:text-base xl:font-medium">135</span>
                </div>
              </div>
              <div className="flex justify-start items-center gap-3">
                <button type="button" className="px-2 rounded-full xl:px-5 hover:text-white hover:bg-yellow-500">

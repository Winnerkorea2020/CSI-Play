      ...
      <div className="grid grid-cols-2 gap-3 ">
        <div className="px-3 py-6 rounded-lg shadow-sm border bg-gray-50">
          <div className="w-full inline-flex justify-between items-center">
            <div className="inline-block w-full px-3 py-2.5 rounded-l-lg bg-blue-500 text-white text-center">Long</div>
          ...
          <div className="mt-3">
            <form action="">
              <div className="grid grid-cols-1 gap-3 text-base">
                ...
                <div className="flex justify-start items-center border rounded-lg">
                  <div className="w-40 text-center py-2.5 px-2">목표 수익률</div>
                  <input
                    type="number"
                    value=""
                    placeholder="0"

        ...
        <div className="grid grid-cols-2 bg-white gap-5">
          {menuItem.map((item, index) => (
            <div className="w-full mx-auto">
              <h3
                key={index}
                className="text-lg tracking-tighter font-medium py-2.5 px-2"
              >
                {item.title}
              </h3>
                  ...
                  >
                    ...
                    <div>
                      <label className="relative inline-flex items-center cursor-pointer">
                        ...
                        />
                        <div className="w-10 xl:w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300  rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all  peer-checked:bg-blue-600"></div>
                      </label>
                    </div>
                  </div>
                ))}
